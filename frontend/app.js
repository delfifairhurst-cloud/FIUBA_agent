...
function appendMessageDOM(sender, text, imageUrl = null, options = {}) {
  ...
  if (sender === 'user') {
    ...
    avatar.innerHTML = window.NivMascot ? NivMascot.avatar(22) : '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/></svg>';
  }
