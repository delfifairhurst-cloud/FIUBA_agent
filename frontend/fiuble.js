...
const FIUBLE_WORDS = [
  ...
  { w: "DERIVADA", topic: "Análisis", hint: "Pendiente instantánea" },
  { w: "INTEGRAL", topic: "Análisis", hint: "Antiderivada / área bajo curva" },
  ...
  { w: "DENSIDAD", topic: "Física", hint: "Masa por volumen" },
  { w: "GRAVEDAD", topic: "Física", hint: "Campo de 9.8 m/s²" },
  { w: "CALOR", topic: "Física", hint: "Energía en tránsito por diferencia de T" },
  { w: "ENTROPIA", topic: "Física", hint: "Medida del desorden" },
  { w: "OSCILAR", topic: "Física", hint: "Movimiento periódico alrededor del equilibrio" },
  // Eléctrica / Señales
  { w: "OHMIO", topic: "Circuitos", hint: "Unidad de resistencia" },
  { w: "VOLTIO", topic: "Circuitos", hint: "Unidad de tensión" },
  { w: "CORRIENTE", topic: "Circuitos", hint: "Flujo de carga" },
  { w: "CIRCUITO", topic: "Circuitos", hint: "Camino cerrado para la corriente" },
  { w: "BOBINA", topic: "Circuitos", hint: "Inductor enrollado" },
  { w: "FARADIO", topic: "Circuitos", hint: "Unidad de capacidad" },
  ...
  { w: "ALEACION", topic: "Materiales", hint: "Mezcla de metales" },
  { w: "ACERO", topic: "Materiales", hint: "Hierro + carbono" },
  { w: "POLIMERO", topic: "Materiales", hint: "Macromolécula de monómeros" },
  ...
  { w: "BERNOULLI", topic: "Fluidos", hint: "Principio de energía en fluidos" },
  { w: "REYNOLDS", topic: "Fluidos", hint: "Número adimensional de régimen" },
  // Programación / Sistemas
  { w: "ALGORITMO", topic: "Programación", hint: "Pasos para resolver un problema" },
  { w: "COMPILAR", topic: "Programación", hint: "Traduce código fuente" },
