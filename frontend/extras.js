  ...
  function showOnboarding() {
    ...
    overlay.innerHTML = `
      <div class="onboarding-card">
        <div class="onboarding-icon" id="onboarding-niv"></div>
    ...
    if (window.NivMascot) NivMascot.render('onboarding-niv', { state: 'idle', size: 56 });
  }
